...
<div class="cover" component="account/cover" style="background-image: url({cover:url}); background-position: {cover:position};">
	...
	<!-- IF canEdit -->
	<div class="controls">
	<span data-keypress-enter tabindex="0" class="upload focusable"><i class="fa fa-fw fa-4x fa-upload"></i></span>
	<span class="resize"><i class="fa fa-fw fa-4x fa-arrows"></i></span>
	<span data-keypress-enter tabindex="0" class="remove focusable"><i class="fa fa-fw fa-4x fa-times"></i></span>
	</div>
