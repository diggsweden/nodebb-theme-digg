<div class="row">
	<!-- IF group.isOwner -->
	<div class="col-lg-2">
		<button data-openmodal component="groups/members/add" type="button" class="btn btn-primary" title="[[groups:details.add-member]]"><i class="fa fa-user-plus"></i></button>
	</div>
	<!-- ENDIF group.isOwner -->
	...
	<tr data-uid="{group.members.uid}">
		...
		<td class="member-name">
			...
			<div class="owner-controls btn-group pull-right">
				...
				<a data-openmodal class="btn btn-sm" href="#" data-ajaxify="false" data-action="kick" title="[[groups:details.kick]]">
					<i class="fa fa-ban"></i>
				</a>
			</div>
			<!-- ENDIF group.isOwner -->
