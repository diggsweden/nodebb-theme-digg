			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="btn-group-vertical btn-block">
						<a data-action="export-profile" data-keypress-enter class="btn btn-default" tabindex="0" >
							<i class="fa fa-download"></i> [[user:consent.export_profile]]
						</a>
						<a data-action="export-posts" data-keypress-enter class="btn btn-default" tabindex="0">
							<i class="fa fa-download"></i> [[user:consent.export_posts]]
						</a>
						<a data-action="export-uploads" data-keypress-enter class="btn btn-default" tabindex="0">
