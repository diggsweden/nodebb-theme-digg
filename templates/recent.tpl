...
<div class="recent">
    <div class="topic-list-header btn-toolbar">
        <div class="pull-left">
            ...
            <!-- ELSE -->
            <a component="category/post/guest" href="{config.relative_path}/login"
                class="btn btn-primary">[[category:guest-login-post]]</a>
            <!-- ENDIF canPost -->
        </div>
		...
		<div class="btn-group <!-- IF !filters.length -->hidden<!-- ENDIF !filters.length -->">
			...
			<ul data-trapfocus class="dropdown-menu" role="menu">
				{{{each filters}}}
				<li role="none" class="category {{{if filters.selected}}}selected{{{end}}}">
						<a role="menuitem" href="{config.relative_path}/{filters.url}"><i
