			...
			<form id="advanced-search">
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-2">
							<label for="match-words-filter">[[search:match-words]]</label>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body search-options collapse <!-- IF expandSearch -->in<!-- ENDIF expandSearch -->">
						<div class="form-group post-search-item">
							<div class="row">
								<div class="col-md-6">
									<label for="posted-in-categories">[[search:in-categories]]</label>
								...
								<div class="col-md-6">
									<div class="form-group post-search-item">
										<div class="row">
											<div class="col-md-6">
												<label for="posted-by-user">[[search:posted-by]]</label>
												<input type="text" class="form-control" id="posted-by-user" placeholder="[[search:posted-by]]">
											</div>
											<div class="col-md-6">
												<label for="has-tags">[[search:has-tags]]</label>
									...
									<div class="form-group post-search-item">
										<div class="row">
											<div class="col-md-6">
                                                <label for="reply-count-filter">[[search:reply-count]]</label>
											...
											<div class="col-md-6">
                                                <label for="reply-count">Ange svarsantal</label>
									...
									<div class="form-group post-search-item">
										<div class="row">
											<div class="col-md-6">
                                                <label for="post-time-filter">[[search:post-time]]</label>
											...
											<div class="col-md-6">
                                                <label for="post-time-range">Ange inläggstid</label>
									...
									<div class="form-group post-search-item">
										<div class="row">
											<div class="col-md-6">
                                                <label for="post-sort-by">[[search:sort-by]]</label>
											...
											<div class="col-md-6">
                                                <label for="post-sort-direction">Välj sorteringsordning</label>
									...
									<div class="form-group post-search-item">
                                        <fieldset>
                                            <legend><strong>[[search:show-results-as]]</strong></legend>
                                            <div class="radio">
                                                <label>
